...
Design-minded developer from **Fukuoka, Japan**. I make interfaces that people actually enjoy using.

---

## Philosophy

Good design is invisible. Bad design is everywhere. I build things where form follows function — clean layouts, intuitive flows, and code that's as readable as the UI.
